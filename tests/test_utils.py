...
from mossspider.estimators.utils import (exp_map, fast_exp_map, exp_map_individual,
                                         network_to_df,
                                         probability_to_odds, odds_to_probability,
                                         bounding, tmle_unit_bounds, tmle_unit_unbound)
...
class TestExposureMapping:
    ...
    def test_exp_map_individual1(self):
        ...
        pdt.assert_frame_equal(expected, exp_map_individual(network=G, variable='A', max_degree=3))
    ...
    def test_exp_map_individual2(self):
        ...
        pdt.assert_frame_equal(expected, exp_map_individual(network=G, variable='A', max_degree=2))
